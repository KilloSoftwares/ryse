				...
				<div class="card">
					...
					<div class="card-body">
							...
							<div class="form-group">
								...
								<textarea name="quantity" id="quantity" cols="30" rows="4" class="form-control"></textarea>
							</div>
					</div>
							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center">
										<!-- <button class="btn btn-sm btn-primary edit_category" type="button" data-id="<?php echo $row['id'] ?>" data-description="<?php echo $row['quantity'] ?>" data-name="<?php echo $row['name'] ?>" ><i class="fa fa-edit"></i></button> -->
