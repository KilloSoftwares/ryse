...
main#view-panel { height: calc(100% - 7em); }
...
main#view-panel { margin-left: inherit; width: calc(100%);}
#page { display: none; }
#loading {
    display: block;
    position: fixed;
...
.goog-te-gadget .goog-te-combo { margin: 0px 0; padding: 8px; color: #000; background: #eeee; }
#google_translate_element{ padding-top: 1px; position: absolute; top: 8px; right: 140px; }
</style>
<body>
<div id="page"></div>
<div id="loading"></div>
...
$(document).ready(function(){
    ...
    // Enable Save button only if paid amount equals total
    $('#uni_modal').on('input', 'input[name="amount_paid"], input[name="total_amount"]', function(){
        let paid = parseFloat($('#uni_modal input[name="amount_paid"]').val()) || 0;
        let total = parseFloat($('#uni_modal input[name="total_amount"]').val()) || 0;
